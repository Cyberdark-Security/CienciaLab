...
static readonly es_strings: i18n_strings = {
  DRAWING_MODE: 'modo de dibujo',
  GRAPH_COLOR: 'color del gráfico',
  GRAPH_DRAW_MODE: 'modo de dibujo del gráfico',
  GRAPH_POINTS: 'número de puntos',
  LINE_WIDTH: 'ancho de línea',
  X_VARIABLE: 'variable X',
  Y_VARIABLE: 'variable Y',
  CLEAR_GRAPH: 'borrar gráfico',
  NONE: '-ninguno-'
};

static readonly i18n = Util.LOCALE === 'de' ? GraphLine.de_strings :
    Util.LOCALE === 'es' ? GraphLine.es_strings : GraphLine.en;
