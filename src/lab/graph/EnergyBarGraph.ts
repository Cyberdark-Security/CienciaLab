...
static readonly es_strings: i18n_strings = {
  ...
  TRANSLATIONAL_ENERGY: 'traslacional',
  KINETIC_ENERGY: 'cinética',
  ROTATIONAL_ENERGY: 'rotacional',
  TOTAL: 'total'
};

static readonly i18n =
    Util.LOCALE === 'de' ? EnergyBarGraph.de_strings :
    Util.LOCALE === 'es' ? EnergyBarGraph.es_strings : EnergyBarGraph.en;
