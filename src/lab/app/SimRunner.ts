...
static es_strings: i18n_strings = {
  TIME_STEP: 'tamaño de paso',
  DISPLAY_PERIOD: 'periodo de imagen',
  RESTART: 'reiniciar',
  RUNNING: 'corriendo',
  FIRING: 'activo',
  PAUSE: 'pausar',
  ...
  NON_STOP: 'sin parar',
  STEP: 'paso',
  STUCK: 'La simulación está atascada; presione reiniciar y continuar para seguir.'
};

static readonly i18n = Util.LOCALE === 'de' ? SimRunner.de_strings :
    Util.LOCALE === 'es' ? SimRunner.es_strings : SimRunner.en;
