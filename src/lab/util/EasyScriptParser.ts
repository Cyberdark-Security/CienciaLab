...
static es_strings: i18n_strings = {
  URL_SCRIPT: 'compartir',
  PROMPT_URL: 'Presione command-C para copiar esta URL al portapapeles, esto replicará esta simulación con los parámetros actuales.',
  WARN_URL_2048: 'ADVERTENCIA: la URL tiene más de 2048 caracteres.'
};
static readonly i18n = Util.LOCALE === 'de' ? EasyScriptParser.de_strings :
    Util.LOCALE === 'es' ? EasyScriptParser.es_strings : EasyScriptParser.en;
