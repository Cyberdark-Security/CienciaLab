...
const es_strings: i18n_strings = {
  NONE: 'ninguno',
  VELOCITY: 'velocidad',
  VELOCITY_AND_DISTANCE: 'velocidad+distancia',
  VELOCITY_JOINTS: 'velocidad (también uniones)',
  VELOCITY_AND_DISTANCE_JOINTS: 'velocidad+distancia (también uniones)'
};

const i18n = Util.LOCALE === 'de' ? de_strings :
    Util.LOCALE === 'es' ? es_strings : en_strings;
