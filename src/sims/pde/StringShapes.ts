...
static readonly es_strings: i18n_strings = {
  FLAT: 'Plano',
  HALF_SINE_PULSE: 'Pulso Semi Seno',
  MULTI_SINE: 'Seno Múltiple',
  SINE_PULSE: 'Pulso Seno',
  SQUARE_PULSE: 'Pulso Rectangular',
  TRIANGLE: 'Triángulo',
  TRIANGLE_PULSE: 'Pulso Triangular'
};

static readonly i18n = Util.LOCALE === 'de' ? StringShapes.de_strings : Util.LOCALE === 'es' ? StringShapes.es_strings : StringShapes.en;
