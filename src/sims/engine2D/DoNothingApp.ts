...
static readonly es_strings: i18n_strings = {
  HANDLE_FORCE: 'fuerza de la manija',
  ROTATE_RATE: 'velocidad de rotación de la fuerza',
  TIGHT_FIT: 'ajuste exacto',
  EXTRA_BLOCK: 'bloque extra',
  HANDLE: 'manija',
  SHUTTLE: 'lanzadera',
  FIXED_BLOCK: 'bloque fijo'
};

static readonly i18n = Util.LOCALE === 'de' ? DoNothingApp.de_strings : Util.LOCALE === 'es' ? DoNothingApp.es_strings : DoNothingApp.en;
