...
static readonly es_strings: i18n_strings = {
  FORMATION: 'formación',
  ONE_HITS_THREE: 'una golpea tres',
  ONE_HITS_SIX: 'una golpea seis',
  OFFSET: 'desplazamiento',
  SPEED: 'velocidad',
  BALL: 'bola'
};

static readonly i18n = Util.LOCALE === 'de' ? BilliardsApp.de_strings : Util.LOCALE === 'es' ? BilliardsApp.es_strings : BilliardsApp.en;
