...
static readonly es_strings: i18n_strings = {
  ...
  FIXED_LEFT_X: 'punto fijo izquierdo X',
  FIXED_LEFT_Y: 'punto fijo izquierdo Y',
  BLOCK_LENGTH: 'longitud del bloque',
  BLOCK_WIDTH: 'ancho del bloque',
  CHAIN: 'cadena',
  WALL_WIDTH: 'ancho de la pared'
};

static readonly i18n = Util.LOCALE === 'de' ? ChainConfig.de_strings : Util.LOCALE === 'es' ? ChainConfig.es_strings : ChainConfig.en;
