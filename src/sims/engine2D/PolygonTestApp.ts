...
static readonly es_strings: i18n_strings = {
  ...
  THRUST: 'empuje',
  ROUND_CORNER: 'esquina redonda',
  PIE_WEDGE: 'porción de pastel',
  HEXAGON: 'hexágono',
  L_SHAPE: 'forma de L',
  BALL: 'bola',
  BLOCK: 'bloque',
...
static readonly i18n = Util.LOCALE === 'de' ? PolygonTestApp.de_strings : Util.LOCALE === 'es' ? PolygonTestApp.es_strings : PolygonTestApp.en;
