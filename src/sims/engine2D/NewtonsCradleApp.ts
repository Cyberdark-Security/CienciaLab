...
static readonly i18n = Util.LOCALE === 'de' ? NewtonsCradleApp.de_strings : Util.LOCALE === 'es' ? NewtonsCradleApp.es_strings : NewtonsCradleApp.en;
