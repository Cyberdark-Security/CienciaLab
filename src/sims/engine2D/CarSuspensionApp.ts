...
static readonly es_strings: i18n_strings = {
  CAR_MASS: 'masa del auto',
  FORMATION: 'formación',
  LENGTH: 'longitud del resorte',
  ROD_SPRING: 'varilla y resorte',
  SPRING_DAMPING: 'amortiguación del resorte',
  STIFFNESS: 'rigidez del resorte',
  TWO_SPRINGS: 'dos resortes',
  WHEEL_MASS: 'masa de la rueda',
  WHEEL: 'rueda',
  CAR: 'auto'
};

static readonly i18n = Util.LOCALE === 'de' ? CarSuspensionApp.de_strings : Util.LOCALE === 'es' ? CarSuspensionApp.es_strings : CarSuspensionApp.en;
...
Util.defineGlobal('sims$engine2D$CarSuspensionApp', CarSuspensionApp);
