...
static readonly i18n = Util.LOCALE === 'de' ? PendulumClockConfig.de_strings : Util.LOCALE === 'es' ? PendulumClockConfig.es_strings : PendulumClockConfig.en;
