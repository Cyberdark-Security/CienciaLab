...
static readonly es_strings: i18n_strings = {
  FORMATION: 'formación',
  ONE_HITS_THREE: 'uno golpea a tres',
  ONE_HITS_TWO: 'uno golpea a dos',
  TWO_HIT_ONE: 'dos golpean a uno',
  ONE_HITS_ONE_ON_WALL: 'uno golpea a uno en la pared',
  ONE_HITS_TWO_ON_WALL: 'uno golpea a dos en la pared',
  ONE_HITS_TWO_SEPARATE: 'uno golpea a dos separados',
  TWO_HIT_ONE_ASYMMETRIC: 'dos golpean a uno asimétrico',
  ONE_HITS_ONE: 'uno golpea a uno',
  ONE_HITS_ONE_ASYMMETRIC: 'uno golpea a uno asimétrico',
  ONE_HITS_WALL: 'uno golpea la pared',
  ONE_HITS_CHAIN: 'uno golpea una cadena',
  ONE_HITS_CHAIN_PLUS_ONE: 'uno golpea una cadena+1',
  TWO_IN_BOX: 'dos en una caja',
  ONE_HITS_TWO_IN_BOX: 'uno golpea a dos en una caja',
  TWO_ON_WALL: 'dos en la pared',
  ANGLE: 'ángulo',
  SHAPE: 'forma',
  CIRCLE: 'círculo',
  SQUARE: 'cuadrado',
...
static readonly i18n = Util.LOCALE === 'de' ? MultipleCollisionApp.de_strings : Util.LOCALE === 'es' ? MultipleCollisionApp.es_strings : MultipleCollisionApp.en;
