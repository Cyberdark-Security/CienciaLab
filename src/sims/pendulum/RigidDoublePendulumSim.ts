...
static readonly es_strings: i18n_strings = {
  ANGLE_1: 'ángulo-1',
  ANGLE_1_VELOCITY: 'velocidad angular-1',
  ANGLE_2: 'ángulo-2',
  ANGLE_2_VELOCITY: 'velocidad angular-2',
  GRAVITY: 'gravedad',
  MASS_1: 'masa-1',
  MASS_2: 'masa-2',
  ROD_1_LENGTH: 'longitud de la varilla-1',
  ROD_2_LENGTH: 'longitud de la varilla-2',
  PENDULUM: 'péndulo'
};

static readonly i18n = Util.LOCALE === 'de' ? RigidDoublePendulumSim.de_strings : Util.LOCALE === 'es' ? RigidDoublePendulumSim.es_strings : RigidDoublePendulumSim.en;
