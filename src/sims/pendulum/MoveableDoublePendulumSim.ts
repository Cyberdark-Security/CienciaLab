...
static readonly es_strings: i18n_strings = {
  ...
  ANCHOR_X: 'ancla X',
  ANCHOR_X_VELOCITY: 'velocidad X del ancla',
  ANCHOR_Y: 'ancla Y',
  ANCHOR_Y_VELOCITY: 'velocidad Y del ancla'
};

static readonly i18n = Util.LOCALE === 'de' ? MoveableDoublePendulumSim.de_strings : Util.LOCALE === 'es' ? MoveableDoublePendulumSim.es_strings : MoveableDoublePendulumSim.en;
