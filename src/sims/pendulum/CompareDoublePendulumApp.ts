...
static readonly i18n = Util.LOCALE === 'de' ? CompareDoublePendulumApp.de_strings : Util.LOCALE === 'es' ? CompareDoublePendulumApp.es_strings : CompareDoublePendulumApp.en;
...
Util.defineGlobal('sims$pendulum$CompareDoublePendulumApp', CompareDoublePendulumApp);
