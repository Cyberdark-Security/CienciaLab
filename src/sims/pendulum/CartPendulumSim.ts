...
static readonly es_strings: i18n_strings = {
  CART_POSITION: 'posición del carrito',
  PENDULUM_ANGLE: 'ángulo del péndulo',
  CART_VELOCITY: 'velocidad del carrito',
  PENDULUM_ANGLE_VELOCITY: 'velocidad angular del péndulo',
  CART_DAMPING: 'amortiguación del carrito',
  PENDULUM_DAMPING: 'amortiguación del péndulo',
  GRAVITY: 'gravedad',
  CART_MASS: 'masa del carrito',
  PENDULUM_MASS: 'masa del péndulo',
  PENDULUM_LENGTH: 'longitud del péndulo',
  SPRING_STIFFNESS: 'rigidez del resorte',
  WORK_FROM_DAMPING: 'trabajo por amortiguación'
};

static readonly i18n = Util.LOCALE === 'de' ? CartPendulumSim.de_strings : Util.LOCALE === 'es' ? CartPendulumSim.es_strings : CartPendulumSim.en;
