...
static readonly es_strings: i18n_strings = {
  ...
  MAGNET_STRENGTH: 'fuerza del imán',
  NUM_MAGNETS: 'número de imanes',
  SYMMETRIC: 'simétrico',
  MAGNET_ANGLE: 'ángulo entre imanes'
};

static readonly i18n = Util.LOCALE === 'de' ? MagnetWheelSim.de_strings : Util.LOCALE === 'es' ? MagnetWheelSim.es_strings : MagnetWheelSim.en;
