...
static readonly es_strings: i18n_strings = {
  ...
  VELOCITY: 'velocidad',
  RPM: 'RPM',
  TORQUE: 'par de estancamiento',
  FREE_SPEED: 'velocidad libre',
  MASS: 'masa',
  ROBOT: 'robot',
  SLOPE: 'pendiente',
  DIAMETER: 'diámetro de la rueda',
  ENGINE_FORCE: 'fuerza del motor',
  GRAVITY_FORCE: 'fuerza de gravedad',
  COEF_FRICTION: 'coef fricción estática',
  CENTER_OF_MASS: 'centro de masa'
};

static readonly i18n = Util.LOCALE === 'de' ? RobotSpeedSim.de_strings : Util.LOCALE === 'es' ? RobotSpeedSim.es_strings : RobotSpeedSim.en;
