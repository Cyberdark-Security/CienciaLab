...
static readonly es_strings: i18n_strings = {
  SIM_WIDTH: 'ancho-sim',
  GRAPH_WIDTH: 'ancho-gráfico',
  TIME_GRAPH_WIDTH: 'ancho-gráfico-temporal',
  LAYOUT: 'diseño',
  SHOW_TERMINAL: 'mostrar terminal',
  SHOW_SIM: 'mostrar simulación'
};

static readonly i18n = Util.LOCALE === 'de' ? TabLayout3.de_strings :
    Util.LOCALE === 'es' ? TabLayout3.es_strings : TabLayout3.en;
