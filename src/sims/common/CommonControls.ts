...
static readonly es_strings: i18n_strings = {
  PAN_ZOOM: 'paneo y zoom',
  BACKGROUND: 'color de fondo',
  WHITE: 'blanco',
  BLACK: 'negro',
  WHITE_WITH_TRAILS: 'blanco con estelas',
  BLACK_WITH_TRAILS: 'negro con estelas',
  WHITE_WITH_LONG_TRAILS: 'blanco con estelas largas',
  BLACK_WITH_LONG_TRAILS: 'negro con estelas largas'
};

static readonly i18n = Util.LOCALE === 'de' ? CommonControls.de_strings :
    Util.LOCALE === 'es' ? CommonControls.es_strings : CommonControls.en;
