...
static readonly es_strings: i18n_strings = {
  ...
  ANCHOR2_X: 'ancla2 X',
  ANCHOR2_Y: 'ancla2 Y',
  NUM_LINKS: 'eslabones de la cadena',
  ...
  STIFFNESS: 'constante del resorte',
  STRAIGHT_LINE: 'línea recta',
  ATTACH_RIGHT: 'fijar a la derecha'
};

static readonly i18n = Util.LOCALE === 'de' ? ChainOfSpringsSim.de_strings : Util.LOCALE === 'es' ? ChainOfSpringsSim.es_strings : ChainOfSpringsSim.en;
