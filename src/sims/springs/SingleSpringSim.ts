...
static es_strings: i18n_strings = {
  ...
  VELOCITY: 'velocidad',
  WORK_FROM_DAMPING: 'trabajo de la amortiguación',
  FIXED_POINT: 'punto fijo'
};

static readonly i18n = Util.LOCALE === 'de' ? SingleSpringSim.de_strings : Util.LOCALE === 'es' ? SingleSpringSim.es_strings : SingleSpringSim.en;
