...
static readonly es_strings: i18n_strings = {
  ...
  LENGTH_SPECIAL: 'longitud del resorte rojo',
  STIFFNESS: 'constante del resorte',
  STIFFNESS_SPECIAL: 'constante del resorte rojo',
  ...
  WALL_SIZE: 'tamaño de la pared',
};

static readonly i18n = Util.LOCALE === 'de' ? Molecule3App.de_strings : Util.LOCALE === 'es' ? Molecule3App.es_strings : Molecule3App.en;
