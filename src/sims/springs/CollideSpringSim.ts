...
static readonly es_strings: i18n_strings = {
  ...
  START_IN_MIDDLE: 'en el medio',
  START_ON_WALL: 'en la pared',
  START_GAP: 'separación inicial'
};

static readonly i18n = Util.LOCALE === 'de' ? CollideSpringSim.de_strings : Util.LOCALE === 'es' ? CollideSpringSim.es_strings : CollideSpringSim.en;
