...
static readonly es_strings: i18n_strings = {
  ...
  THIRD_SPRING: 'tercer resorte'
};

static readonly i18n = Util.LOCALE === 'de' ? DoubleSpringSim.de_strings : Util.LOCALE === 'es' ? DoubleSpringSim.es_strings : DoubleSpringSim.en;
