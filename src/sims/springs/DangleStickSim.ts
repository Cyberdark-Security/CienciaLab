...
static readonly es_strings: i18n_strings = {
  SPRING_ANGLE: 'ángulo del resorte',
  SPRING_ANGULAR_VELOCITY: 'velocidad angular del resorte',
  SPRING_LENGTH: 'longitud del resorte',
  SPRING_LENGTH_VELOCITY: 'velocidad de longitud del resorte',
  STICK_ANGLE: 'ángulo del palo',
  STICK_ANGULAR_VELOCITY: 'velocidad angular del palo',
  GRAVITY: 'gravedad',
  MASS1: 'masa-1',
  MASS2: 'masa-2',
  SPRING_REST_LENGTH: 'longitud de reposo del resorte',
  SPRING_STIFFNESS: 'constante del resorte',
  STICK_LENGTH: 'longitud del palo'
};

static readonly i18n = Util.LOCALE === 'de' ? DangleStickSim.de_strings : Util.LOCALE === 'es' ? DangleStickSim.es_strings : DangleStickSim.en;
