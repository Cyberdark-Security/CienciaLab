...
static readonly es_strings: i18n_strings = {
  ...
  LENGTH_1: 'longitud del resorte 1',
  STIFFNESS_1: 'constante del resorte 1',
  LENGTH_2: 'longitud del resorte 2',
  STIFFNESS_2: 'constante del resorte 2',
  VELOCITY_1: 'velocidad 1',
  VELOCITY_2: 'velocidad 2'
};

static readonly i18n = Util.LOCALE === 'de' ? CollideBlocksSim.de_strings : Util.LOCALE === 'es' ? CollideBlocksSim.es_strings : CollideBlocksSim.en;
