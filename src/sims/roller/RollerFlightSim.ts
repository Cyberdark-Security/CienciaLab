...
static readonly es_strings: i18n_strings = {
  ...
  TRACK_MODE: 'modo de trayectoria',
  TRACK_POSITION: 'posición en la trayectoria',
  TRACK_VELOCITY: 'velocidad en la trayectoria',
  VELOCITY: 'velocidad',
...
static readonly i18n = Util.LOCALE === 'de' ? RollerFlightSim.de_strings : Util.LOCALE === 'es' ? RollerFlightSim.es_strings : RollerFlightSim.en;
