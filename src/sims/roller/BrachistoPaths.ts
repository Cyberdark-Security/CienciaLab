...
static readonly es_strings: i18n_strings = {
  ...
  BRACH_SQUARED: 'braquistócrona-al-cuadrado',
  CIRCLE_ARC: 'círculo',
  LINEAR_PATH: 'lineal',
  PARABOLA_DOWN: 'parábola-abajo',
  PARABOLA_UP: 'parábola-arriba'
};

static readonly i18n = Util.LOCALE === 'de' ? BrachistoPaths.de_strings : Util.LOCALE === 'es' ? BrachistoPaths.es_strings : BrachistoPaths.en;
