...
static readonly es_strings: i18n_strings = {
  ...
  START_T_VALUE: 't-inicial',
  FINISH_T_VALUE: 't-final'
};

static readonly i18n = Util.LOCALE === 'de' ? RollerSingleApp.de_strings : Util.LOCALE === 'es' ? RollerSingleApp.es_strings : RollerSingleApp.en;
