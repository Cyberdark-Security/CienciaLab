...
static readonly es_strings: i18n_strings = {
  PATH: 'trayectoria',
  QUESTION: '¿Qué trayectoria es más rápida para deslizarse hacia abajo?  Haga clic en una trayectoria para comenzar.',
  YOU_PICKED: 'Usted eligió la'
};

static readonly i18n = Util.LOCALE === 'de' ? BrachistoObserver.de_strings : Util.LOCALE === 'es' ? BrachistoObserver.es_strings : BrachistoObserver.en;
