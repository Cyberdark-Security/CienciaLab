...
static readonly es_strings: i18n_strings = {
  BLOCK: 'bloque',
  PATH_POSITION: 'posición en la trayectoria',
  PATH_VELOCITY: 'velocidad en la trayectoria'
};

static readonly i18n = Util.LOCALE === 'de' ? RigidBodyRollerApp.de_strings : Util.LOCALE === 'es' ? RigidBodyRollerApp.es_strings : RigidBodyRollerApp.en;
